...
\exe{4}{
	Dans cette question, on suppose que 20 nouveaux élèves apprennent la rumeur chaque jour.
...
\exe{4}{
	...
	Dans les deux cas, y faire figurer le jour où, dans chacun des cas, le lycée tout entier apprend la rumeur. 
}{exe:1}{
	todo
}
