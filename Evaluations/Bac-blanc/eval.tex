...
\begin{enumerate}[label=\textbf{\arabic*.}]\setcounter{enumi}{10}
	...
	\begin{enumerate}[label=\textbf{\alph*)}]
		...
		\item
		$\left( \dfrac{464}{544,4}- 1\right)^{1/3}\times100$
		\item
		$\left( \dfrac{544,4}{464} -1 \right)^{3}\times100$
		\item
		$\left( \dfrac{544,4}{464}-1 \right)^{1/3}\times100$
	\end{enumerate}
	\end{multicols}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item On a tracé dans le repère suivant les fonctions $f$ et $g$. A laquelle de ces deux fonctions correspond la droite en pointillés ?
		\begin{center}
