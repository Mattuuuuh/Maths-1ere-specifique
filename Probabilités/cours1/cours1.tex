...
\begin{questions*}{}{}
	\begin{enumerate}[label=\roman*)]
		\item La probabilité d'un événement change-t-elle lorsqu'une nouvelle information est disponible ?
		...
		\item Comment démontrer que deux événements sont indépendants ?
	\end{enumerate}
\end{questions*}
...
\begin{methode*}{}{}
	\begin{enumerate}[label=$\bullet$]
		...
		\item Pour connaître la probabilité d'une feuille, il faut multiplier les probabilités du chemin racine-feuille.
		\item Pour connaître la probabilité d'un événement, il faut sommer la probabilité de chaque feuille lui correspondant.
	\end{enumerate}
\end{methode*}
