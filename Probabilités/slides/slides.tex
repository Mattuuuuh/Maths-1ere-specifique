...
\begin{frame}{Let's Make a Deal}
	...
	\only<1-5>{
	\begin{itemize}
		\item Les portes cachent deux chèvres et une voiture. 
		\pause
		\item Le joueur choisit une porte.
		\pause
		\item Le présentateur ouvre une des deux autres portes, découvrant une chèvre.
		\pause
		\item Le joueur a-t-il intérêt à changer de porte ?
	 \end{itemize}
	 }
