...
\exe{1}{
	On reprend l'énoncé de l'exercice \ref{exe:decibels} du chapitre sur les suites géométriques.
	\begin{enumerate}
		\item
		À quelle pression correspond 100dB ? et 106 dB ?
		
		\item
		Donner un encadrement de la pression à 103 dB à l'aide de la première question.
		Calculer la pression à l'aide de la calculatrice.
		
		\item
		À quelle pression correspond 88 dB ? et 82 dB ?
		
		\item
		Donner un encadrement de la pression à 85 dB à l'aide de la troisième question.
		Calculer la pression à l'aide de la calculatrice.
	\end{enumerate}
}{exe:decibels2}{
	TODO
