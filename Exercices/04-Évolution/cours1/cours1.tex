...
\fancyhead[C]{\textbf{Chapitre 3 — Évolutions}}
\fancyhead[R]{\today}
...
\thm{}{
	...
	\begin{enumerate}
		\item Augmenter de $P \%$ revient à multiplier par $m = 1 + \frac{P}{100}$.
		\item Diminuer de $P \%$ revient à multiplier par $m = 1 - \frac{P}{100}$.
	\end{enumerate}
	...
	\begin{tikzpicture}
		...
		\draw[->, thick, RED_E] (1cm,-.5cm) arc (-105:-75:15) node[midway, below=5pt] {$\times \dots\dots\dots\dots$};
	\end{tikzpicture}
	\end{center}
}{thm:ev-succ}
...
\thm{}{
	...
	\begin{tikzpicture}
		...
		% vertices
		\draw[->, thick, BLUE_E] (1cm,.6cm) arc (105:75:7) node[midway, above] {$\times m_1$};
		\draw[->, thick, BLUE_E] (6cm,.6cm) arc (105:75:7) node[midway, above] {$\times \dots\dots$};
		
		\draw[->, thick, RED_E] (1cm,-.5cm) arc (-105:-75:15) node[midway, below=5pt] {$\times \dots\dots$};
	\end{tikzpicture}
	\end{center}
}{thm:ev-rec}
...
\ex{}{
	\begin{enumerate}
		\item Une augmentation de 20\% correspond à multiplier par 1,2.
		\item Une diminution de 30\% correspond à multiplier par 0,7.
	\end{enumerate}
}{ex:ev}
...
\dfn{}{
	...
	De plus, \hspace{70pt} $q^0 = 1$ \hspace{70pt} et \hspace{70pt} $q^{-n} = \dfrac1{q^n}$.
}{dfn:puissances}
