...
\chapter{Pourcentages et évolution}
...
\nt{
	...
	\footnote{L'\emphindex{évolution absolue} correspond à la simple différence ``valeur finale -- valeur initiale''. Par exemple et selon le GIEC, la température moyenne mondiale a augmenté d'environ 1,1°C depuis le début de l'industrialisation ($19^{\text{è}}$ siècle).}
...
\thm{Évolution moyenne}{
	...
	\begin{center}
	\includegraphics[page=3]{figures/fig-exponentielles.pdf}
	\end{center}
}{}
