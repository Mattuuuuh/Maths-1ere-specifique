...
\SetKwInOut{Input}{entrée}\SetKwInOut{Output}{sortie}
	...
	\BlankLine
	\emph{L'intervalle $I=[a;b]$ de départ doit vérifier $G(a) < M < G(b)$, de telle sorte que l'entier $N$ recherché lui appartienne nécessairement car $G$ est croissante. On pourrant prendre $a=0$ et $b$ extrêmement grand en cas de doute.}\\
