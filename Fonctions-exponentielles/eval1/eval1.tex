...
\fancyhead[C]{\textbf{Évaluation blanche -- Fonctions exponentielles \ifsolutions -- Solutions \fi}}
\fancyhead[R]{\today}
...
\exe{
	Soit $f, g, h$ des fonctions exponentielles. Déterminer la base $q$ et la valeur en $0$ de chaque fonction avec les informations suivantes.
...
\exe{
	...
	\begin{enumerate}
		...
		\item En déduire le taux d'évolution moyen.
	\end{enumerate}
...
\exe{
	...
	\begin{enumerate}
		...
		\item En combien de semaines le premier malade a-t-il infecté $18\ 347$ peronnes ? On cherche le plus petit $t$ tel que $M(t) \geq 1$. Arrondir à  $10^{-1}$.
	\end{enumerate}
